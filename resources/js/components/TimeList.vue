                                  ...
                                  <div class="flex items-center space-x-3 min-w-0 flex-1">
                                    ...
                                    <div class="flex items-center space-x-2 min-w-0">
                                      <B24Badge
                                          ...
                                          class="whitespace-normal md:whitespace-nowrap max-w-full inline-block over px-2 py-1 text-xs"
                                      >
                          ...
                          <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3 min-w-0 flex-1">
                              ...
                              <div class="flex items-center space-x-2 min-w-0">
                                <B24Badge
                                    :class="getCategoryBadgeClass(categoryData.category)"
                                    class="whitespace-normal md:whitespace-nowrap max-w-full inline-block px-2 py-1 text-xs"
                                >
                                  {{ categoryData.category || 'Не указана' }}
                                </B24Badge>
                              </div>
