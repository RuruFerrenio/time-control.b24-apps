                      ...
                      >
                        <div class="flex items-center justify-between">
                          <div class="flex items-center space-x-3 min-w-0 flex-1">
                            ...
                            <div v-if="userData.userId !== currentUserId && subordinateReportsEnabled" class="flex justify-center hidden sm:block">
                              <B24Button
...
class HierarchicalDataManager {
  ...
  createStructuredReportRequest() {
    ...
    const reportUrl = `/marketplace/view/app.69ac5935f13166.52222394/?params[parameters]=${reportParams.parameters}`
