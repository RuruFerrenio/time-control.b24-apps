                            ...
                            <div class="mt-3">
                              <div class="flex items-start p-3 bg-blue-50 rounded-lg">
                                ...
                                <div class="text-sm text-blue-700">
                                  Стремитесь к тому, чтобы показатель "Времени не сохранено", стремился к 0%. Для этого необходимо время, проведенное на страницах Битрикс24 связывать с задачами, в рамках которых выполнялись те или иные действия. Сделать это можно во вкладке "История посещений"
                                </div>
                              </div>
                            </div>
                          </div>
