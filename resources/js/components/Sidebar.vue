<template>
  <div class="lg:sticky lg:top-6 space-y-6">
    ...
    <B24Card>
        <script src="https://forms.yandex.ru/_static/embed.js"></script><iframe src="https://forms.yandex.ru/u/69ac34e6505690a2bcabb0f4?iframe=1" frameborder="0" name="ya-form-69ac34e6505690a2bcabb0f4"></iframe>
    </B24Card>
  </div>
</template>
