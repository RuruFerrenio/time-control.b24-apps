          ...
          <div class="space-y-3">
            ...
            <nav class="space-y-2">
              ...
              >
                ...
                <div class="absolute left-0 top-full mt-1 px-2 py-1 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-10">
                  В следующей версии...
                </div>
              </div>
