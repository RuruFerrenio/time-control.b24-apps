          ...
          <div class="space-y-3 pt-4 border-t border-gray-200">
            ...
            >
              <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4z M20 12c0 4.42-3.58 8-8 8s-8-3.58-8-8 3.58-8 8-8 8 3.58 8 8z M12 6v2 M12 16v2 M10 9h3.5a1.5 1.5 0 0 1 0 3H10h1.5a1.5 1.5 0 0 1 0 3H10"></path>
              </svg>
              Поддержать проект
            </B24Button>
