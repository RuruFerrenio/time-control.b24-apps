...
export const messages = {
  ru: {
    ...
    install: {
      title: "Установка приложения «Калькулятор под рукой»",
      subtitle: "Настройте приложение под свои нужды за несколько простых шагов",
      progress: "Прогресс",
      welcome: {
        title: "Добро пожаловать!",
        description: "Приложение «Калькулятор под рукой» позволяет проводить математические расчеты прямо в интерфейсе Битрикс24. Настройте приложение под свои потребности."
      },
      features: {
    ...
    presenceCheck: {
      title: 'Вы еще здесь?',
      description: 'Подтвердите свое присутствие для продолжения работы',
      confirmButton: 'Я здесь',
      confirmed: 'Подтверждено ✓',
      timeExpired: 'Время истекло',
      timeRemaining: 'Осталось времени',
      timeExpiredMessage: 'Время вышло! Ваше отсутствие зафиксировано.',
      confirmedMessage: 'Присутствие подтверждено! Приложение закроется автоматически.',
      successNotification: 'Ваше присутствие подтверждено!',
      absenceNotification: 'Ваше отсутствие зафиксировано, данные об этом переданы руководителю.',
